...
.with_frm_style .frm_right_container label.frm_primary_label, .with_frm_style .frm_pos_right{display:inline;float:right;margin-left:10px;width:<?php echo $width . $important; ?>;}
...
.with_frm_style input[type=text], .with_frm_style input[type=password], .with_frm_style input[type=email], .with_frm_style input[type=number], .with_frm_style input[type=url], .with_frm_style input[type=tel], .with_frm_style select, .with_frm_style textarea, #content .with_frm_style input:not([type=submit]), #content .with_frm_style select, #content .with_frm_style textarea, .with_frm_style .chzn-container{font-family:<?php echo stripslashes($font)  . $important ?>;font-size:<?php echo $field_font_size ?>;margin-bottom:0;}
.with_frm_style input[type=text], .with_frm_style input[type=password], .with_frm_style input[type=email], .with_frm_style input[type=number], .with_frm_style input[type=url], .with_frm_style input[type=tel], .with_frm_style select, .with_frm_style textarea, .frm_form_fields_style, .with_frm_style .frm_scroll_box .frm_opt_container, .frm_form_fields_active_style, .frm_form_fields_error_style, .with_frm_style .chzn-container-multi .chzn-choices, .with_frm_style .chzn-container-single .chzn-single{color:#<?php echo $text_color . $important ?>;background-color:#<?php echo $bg_color . $important ?>;border-color:#<?php echo $border_color . $important ?>;border-width:<?php echo $field_border_width . $important ?>;border-style:<?php echo $field_border_style . $important ?>;-moz-border-radius:<?php echo $border_radius . $important ?>;-webkit-border-radius:<?php echo $border_radius . $important ?>;border-radius:<?php echo $border_radius . $important ?>;width:<?php echo ($field_width == '') ? 'auto' : $field_width ?>;max-width:100%;font-size:<?php echo $field_font_size . $important ?>;padding:<?php echo $field_pad . $important ?>;-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;outline:none <?php echo $important ?>;font-weight:normal;}
