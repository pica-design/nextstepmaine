    ...
    <section class="content-wrapper">
        <div class="page-content full-width">
            ...
            <div class="filter-options">
	            ...
	            <div class="button gray inline padded rounded <?php echo $high_school_active ?>"><a href="<?php echo get_permalink($post->ID) ?>high-school" title="High School Programs">High School Diploma</a></div>
	        	<div class="button gray inline padded rounded <?php echo $associate_active ?>"><a href="<?php echo get_permalink($post->ID) ?>associate" title="Associate Programs">Associate Degress</a></div>
	        	<div class="button gray inline padded rounded <?php echo $bachelor_active ?>"><a href="<?php echo get_permalink($post->ID) ?>bachelor" title="Bachelor Programs">Bachelor Degree</a></div>
        	</div>
            <table cellpadding="0" cellspacing="0" border="0" class="tablesorter jobs">
                ...
                <tbody>
					...
					$job_education_levels = get_terms('nsm_job_education_requirement', array(
						'orderby' => 'custom_sort',
						'include' => $education_requirement_obj->term_id
					));
