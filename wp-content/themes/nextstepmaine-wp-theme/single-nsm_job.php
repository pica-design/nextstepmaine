        ...
        <div class="page-content">
        	<?php if (have_posts()) : ?>
            	<?php while (have_posts()) : the_post() ?>
                	<h2><?php the_title() ?></h2>
                    <br />
					Employment 2008: <?php echo get_post_meta($post->ID, '_employment_2008', true) ?><br />
					Employment 2018: <?php echo get_post_meta($post->ID, '_employment_2018', true) ?><br />
                    Growth Rate: <?php echo get_post_meta($post->ID, '_growth_rate', true) ?><br />
